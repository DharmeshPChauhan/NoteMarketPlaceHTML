...
<head>
    ...
    <!-- Title -->
    <title>MyProfile - Notes Marketplace</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="myprofile-first-name" placeholder="Enter your first name" value="Johnson">
                        </div>
                        <div class="form-group">
                            <label for="Last Name">Last Name *</label>
                            <input type="text" class="form-control" id="myprofile-last-name" placeholder="Enter your last name" value="Peterson">
                        </div>
                        <div class="form-group">
                            <label for="Email">Email *</label>
                            <input type="email" class="form-control" id="myprofile-email" placeholder="Enter your email address" value="admin123@gmail.com" disabled>
                        </div>
                        <div class="form-group">
                            <label for="Secondary Email">Secondary Email</label>
                            <input type="text" class="form-control" id="myprofile-secondary-email" placeholder="Enter your secondary email">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select class="form-control" id="myprofile-phone-no-code">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="myprofile-phone-number" placeholder="Enter your phone number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Profile Picture">Profile Picture</label>
                            <textarea class="form-control" id="myprofile-profile-picture" rows="4" placeholder="Upload a Picture"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
