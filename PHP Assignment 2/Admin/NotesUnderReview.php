                                ...
                                <td>
                                    <div class='action-img'>
                                        <div class='view-seller-icon'>
                                            <a href='MemberDetails.php?member_id=$seller_id'><img src='images/Dashboard/eye.png' alt='View' class='img-responsive'></a>
                                        </div>
                                    </div>
                                </td>
                                <td>$date_added</td>
