        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-12 table-responsive'>
                    <table class='table table-hover' id='downloaded-note-info-table'>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                                    ...
                                    <div class='action-img'>
                                        <div class='action-downloaded-note dropleft'>
                                            ...
                                            <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                                                <a class='dropdown-item' href='DownloadedNotes.php?admin_download_note=$note_path'>Download Notes</a>
                            ...
                            <tr>
                                <td>1</td>
                                <td><a href='NoteDetails-admin.php'>Computer Basic</a></td>
                                <td>Computer</td>
                                <td>Niya Patel</td>
                                <td>
                                    <div class='action-img'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-img">
                                        <div class="action-downloaded-note dropleft">
                                            <a id="downloaded-note-action-dropdownMenu" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/Dashboard/dots.png" alt="More" class="img-risponsive"></a>
