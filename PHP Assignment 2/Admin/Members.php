...
<body>
    ...
    <section id="members-info">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-hover" id="members-info-table">
                        <thead>
                            <tr>
                                ...
                                <td>
                                    <div class="action-img">
                                        <div class="action-members dropleft">
                                            <a id="members-action-dropdownMenu" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/Dashboard/dots.png" alt="More" class="img-risponsive"></a>
