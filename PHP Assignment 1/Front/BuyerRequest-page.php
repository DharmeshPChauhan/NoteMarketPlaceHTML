                ...
                <div class="col-sm-12 col-md-12">
                    <table class="table table-hover table-responsive w-100 d-block d-md-table" id="buyerrequest-notes-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><a href="Note_Details.php">Data Science</a></td>
                                <td>Science</td>
                                ...
                                <td>
                                    <div class="action-img">
                                        <div class="view-buyerrequest-note">
                                            <a href="Note_Details.php"><img src="images/Dashboard/eye.png" alt="Edit" class="img-risponsive"></a>
                                        </div>
                            ...
                            <tr>
                                <td>2</td>
                                <td><a href="Note_Details.php">Accounts</a></td>
                                <td>Commerce</td>
                                <td>mymail123@gmail.com</td>
                                <td>+91 1234567890</td>
                                <td>Free</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td><a href="Note_Details.php">Social Studies</a></td>
                                <td>Social</td>
                                <td>mymail123@gmail.com</td>
                                <td>+91 1234567890</td>
                                <td>Free</td>
                            ...
                            <tr>
                                <td>4</td>
                                <td><a href="Note_Details.php">AI</a></td>
                                <td>IT</td>
                                <td>mymail123@gmail.com</td>
                                <td>+91 1234567890</td>
                                <td>Paid</td>
                            ...
                            <tr>
                                <td>5</td>
                                <td><a href="Note_Details.php">Data Structure</a></td>
                                <td>Science</td>
                                <td>mymail123@gmail.com</td>
                                <td>+91 1234567890</td>
                                <td>Free</td>
