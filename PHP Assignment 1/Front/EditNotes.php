                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_of_pages" class="form-control" id="addnote-note-pages" placeholder="Enter number of note pages" value="<?php echo $edit_note_number_of_pages; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sell_mode" id="selling-free" value="free" <?php if($edit_note_sell_mode == 0){echo "checked";}?> required>    
                                    <label class="form-check-label" for="free">Free</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sell_mode" id="selling-paid" value="paid" <?php if($edit_note_sell_mode == 1){echo "checked";}?> required>
                                    <label class="form-check-label" for="paid">Paid</label>
                                </div>
                            </div>
                            <div class="form-group" id="show_sell_price">
                                <label for="Sell Price">Sell Price *</label>
                                <input type="text" name="sell_price" class="form-control" id="addnote-note-sell-price" placeholder="Enter your price" pattern="^[1-9]{1}[0-9]*(\.[0-9]{1,2})?$" value="<?php echo $edit_note_price; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<?php 
        if($edit_note_sell_mode == 1) {
            echo "<script>$(document).ready(function() {"."$('#show_sell_price').show();});</script>";
        }
?>
<script>
