...
<?php
    if(isset($_POST['type_submit'])){
        ...
        $add_type_query = "INSERT INTO types (type_name, type_description, type_added_by_user, type_edited_by_user) 
        VALUES ('{$type_name}', '{$type_desc}', 'admin', 'admin');";
        
        $check_add_type_query = mysqli_query($connection, $add_type_query);
        
        if(!$check_add_type_query){
