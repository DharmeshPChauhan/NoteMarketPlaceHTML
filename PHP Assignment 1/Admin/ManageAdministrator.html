...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="add-administrator-btn" id="add-administrator">
                                <a class="btn btn-general btn-purple" href="AddAdministrator.html" title="Add Administrator" role="button">Add Administrator</a>
                            </div>
                        </div>
    ...
    <section id="administrator-info">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-hover" id="administrator-info-table">
                        <thead>
                            <tr>
